...
class Channel_1 {
    get NR10() { return this.memory[mapping.NR10_ADDR]; }
    get NR11() { return this.memory[mapping.NR11_ADDR]; }
    get NR12() { return this.memory[mapping.NR12_ADDR]; }
    get NR13() { return this.memory[mapping.NR13_ADDR]; }
    get NR14() { return this.memory[mapping.NR14_ADDR]; }
    //Unused NR15

    //Sweep time(update rate) (if 0, sweeping is off)
    get sweepTime() { return (this.NR11 & 0x70) >> 4; }
    set sweepTime(x) {
    ...
    get sweepDirection() { return (this.NR11 & 0x8) >> 3; }
    ...
    get sweepAmount() { return this.NR11 & 0x7; }
    ...
    get duty() { return (this.NR11 & 0xc0) >> 6; }
    get lengthCounter() { return (this.NR11 & 0x3f); } //t1
    set duty(x) { this.memory[mapping.NR11_ADDR] = (x << 6) | (this.memory[mapping.NR11_ADDR] & 0x3f); }
    set lengthCounter(x) {
    ...
    set counterSelection(x) { //1 = stop when length in NR11 expires
...
class Channel_2 {
    get NR21() { return this.memory[mapping.NR21_ADDR]; }
    get NR22() { return this.memory[mapping.NR22_ADDR]; }
    get NR23() { return this.memory[mapping.NR23_ADDR]; }
    get NR24() { return this.memory[mapping.NR24_ADDR]; }


    get duty() { return (this.NR21 & 0xc0) >> 6; }
    get lengthCounter() { return (this.N211 & 0x3f); } //t1
    set duty(x) { this.memory[mapping.NR21_ADDR] = (x << 6) | (this.NR21 & 0x3f); }
    set lengthCounter(x) { this.memory[mapping.NR21_ADDR] |= x; }

    get initialVolume() { return (this.NR22 & 0xf0) >> 4; }
    set initialVolume(x) {
        this.memory[mapping.NR22_ADDR] &= 0b00001111;
        this.memory[mapping.NR22_ADDR] |= (x << 4);
    }

    get volumeSweepDirection() { return (this.NR22 & 0x8) >> 3; }
    set volumeSweepDirection(x) {
        if ( x ) this.memory[mapping.NR22_ADDR] |= (1 << 3);
        else this.memory[mapping.NR22_ADDR] &= 0b11110111;
    }

    get volumeSweepStepLength() { return this.NR22 & 0x7; }
    set volumeSweepStepLength(x) {
...
class Channel_3 {
    get NR30() { return this.memory[mapping.NR30_ADDR]; }
    get NR31() { return this.memory[mapping.NR31_ADDR]; }
    get NR32() { return this.memory[mapping.NR32_ADDR]; }
    get NR33() { return this.memory[mapping.NR33_ADDR]; }
    get NR34() { return this.memory[mapping.NR34_ADDR]; }


    get masterStatus() { return this.NR30 & 0x80 ? 1 : 0; }
    set masterStatus(x) { //1 playback
    ...
    get lengthCounter() { return (this.NR31 & 0xff); }
    ...
    get volume() { return (this.NR32 & 0x60) >> 5; }
    set volume(x) {
    ...
    setCounterSelection(x) { //1 = stop when length in NR11 expires
...
class Channel_4 {
    get NR41() { return this.memory[mapping.NR41_ADDR]; }
    get NR42() { return this.memory[mapping.NR42_ADDR]; }
    get NR43() { return this.memory[mapping.NR43_ADDR]; }
    get NR44() { return this.memory[mapping.NR44_ADDR]; }
