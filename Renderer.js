class Renderer {
	...
	constructor(system) {
		...
		this.tips.innerHTML ="<h3>【﻿ｃｏｍｍａｎｄｓ】 ぴマ益:</h3><strong>【﻿ｕｐ】:</strong> Z<br/><strong>【﻿ｒｉｇｈｔ】:</strong> D<br/><strong>【﻿ｄｏｗｎ】:</strong> S<br><strong>【﻿ｌｅｆｔ】:</strong> Q<br/><strong>【﻿Ａ】 (どさテ):</strong> A<br/><strong>【﻿Ｂ】　(テ-ヿ):</strong> E<br/><strong>【﻿ｓｔａｒｔ】:</strong> P<br><strong>【﻿ｓｅｌｅｃｔ】:</strong> O";
	}
	...
	loop() {
		...
		let _frame = () => {
			...
			if ( start ) {
				...
				this.fps.innerHTML = '<strong>【﻿ｆｐｓ】　胃汚流</strong>: ' + avg.toPrecision(3) + 'ムゕ億';
			}
